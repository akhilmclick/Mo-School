...
export default function RoleSelectPage() {
  ...
  const roleCards = [
    {
      ...
      bgBadge: "bg-indigo-50 text-indigo-700 border-indigo-200/60",
    ...
    },
    {
      ...
      bgBadge: "bg-orange-50 text-orange-700 border-orange-200/60",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#F3F4F6] via-[#F8F9FA] to-[#ECEEF2] flex items-center justify-center p-4 sm:p-6 relative">
      <div className="w-full max-w-lg relative z-10">
        <div className="text-center mb-6">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-900 text-white text-xs font-bold mb-3 shadow-sm">
          ...
          {availableRoleCards.map((card) => {
            ...
            return (
              <button
                ...
                className="w-full text-left bg-white/95 backdrop-blur-md rounded-3xl p-5 shadow-card border border-black/[0.04] hover:shadow-lg hover:border-slate-300 transition-all group relative overflow-hidden"
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2 mb-1">
                      ...
                      <span className="text-xs text-slate-400 group-hover:text-slate-900 group-hover:translate-x-1 transition-all flex items-center font-semibold">
                        Enter <ArrowRight className="w-3.5 h-3.5 ml-1" />
                      </span>
                    </div>

                    <h3 className="text-base font-extrabold text-slate-900 group-hover:text-slate-950">
                      {card.title}
                    </h3>
